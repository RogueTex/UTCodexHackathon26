...
export function ReportPageClient({ intent }: Props) {
  ...
  useEffect(() => {
    // Initialize the input from local storage once on mount.
  ...
  function saveByokKey() {
    ...
    setByokStatus(byokApiKey.trim() ? "Saved. Future analyzes use your key." : "Key removed.");
  }
            ...
            <div className="composer-grid">
              ...
              <div className="composer-side">
                ...
                <div className="support-card">
                  ...
                  <h3>Use live OpenAI image analysis</h3>
                  <p>
                    Paste your OpenAI API key to run live model analysis for uploads.
                    If blank, BevoFix uses deterministic fallback matching.
                  </p>
                  <input
                    type="password"
                    value={byokApiKey}
                  ...
                  <p className="hint-text">
                    {byokStatus ?? "Stored in your browser localStorage only."}
                  </p>
                </div>
